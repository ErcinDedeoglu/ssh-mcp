 ...
 */
export function launchBackgroundJob(serverId, command, options = {}) {
    ...
    const args = [entry, 'run-job', jobId, serverId, '--config', getConfigPath()];
...
//# sourceMappingURL=job-launch.js.map